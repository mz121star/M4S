...
class CarRepairController extends BaseController {
    public function ListAction(){
        ...
        $url=C('API_ADDRESS')."/CarHealthy/FindRepair";
    ...
    public function DeleteAction(){
        $id=I('get.id');
        $url=C('API_ADDRESS')."/CarHealthy/DeleteRepair?id=".$id;
        $result=getPage($url,'GET');
        $this->ajaxReturn ($result,'JSON');
    }
    ...
    public function UpdateAction(){
        ...
        $url=C('API_ADDRESS')."/CarHealthy/UpdateRepair";
