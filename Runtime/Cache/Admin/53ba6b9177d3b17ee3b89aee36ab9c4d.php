               ...
               <!-- END NOTIFICATION DROPDOWN -->
                ...
                <li class="dropdown user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="username"><?php echo session('uname'); ?></span>
                        <i class="icon-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu">

                        <li><a href="../Index/logout"><i class="icon-key"></i>登出</a></li>
                    </ul>
                </li>
...
<div class="page-container" id="main-container">
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="" ng-repeat="n in navs">
                ...
                <ul class="sub-menu"  >
                    <li ng-repeat="n1 in n.subnav" ng-class="{'active': active==n1.name}">
                        <a href="{{n1.url}}" ng-click="linkClick(n1)">
                            {{n1.name}}</a>
                    </li>
                </ul>
            </li>
    ...
    <!--<footer>
        <hr />
        <p><strong>Copyright &copy; 2014 车音网</strong></p>
...
<!-- END CORE PLUGINS -->
<link href="/js/jasny-bootstrap.min.js" rel="stylesheet" />
...
<div id="updateexample" class="modal hide fade" tabindex="-1">
    <div class="row-fluid">
        <div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
            <div class="portlet box blue">
                <div class="portlet-title ">
                    <div class="caption"><i class="icon-user"></i>修改密码</div>
                    <div class="actions">
                        ...
                        <div class="row-fluid">
                            <div class="span6 ">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password"  ng-required="true" ng-model="user.password" class="m-wrap span6" />
                                    </div>
                                </div>
                            </div>
                            <div class="span6 ">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" ng-required="true"  ng-model="user.confirmpassword" class="m-wrap span6" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer no-margin-top" style="text-align: right">
                <button type="button" nm-model="user" ng-disabled='searchForm.$invalid' data-dismiss="modal" ng-click="UpdatePassword(user)" class="btn btn-sm purple">
